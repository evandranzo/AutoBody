...
<head>
    ...
    <!-- TITLE -->
    <title>Update a Mechanic in the AutoBody Repair Shop database</title>
</head>

<body>
    <h3>Update a Mechanic in the AutoBody Repair Shop database</h3>
    <?php
            ...
            echo "
            <form id='update' name='update' method='POST' action='UpdateMechanic.php'>
            <div class='row'>
                <div class='col-25'>
    ...
    <?php
            ...
            name = '".$_POST['name']."',
            Num_of_Jobs_Assigned = '".$_POST['Num_of_Jobs_Assigned']."',
            rate = '".$_POST['rate']."'
            WHERE mechanicID = '".$_POST['mechanicID']."';"
            ;
