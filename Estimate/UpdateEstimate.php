...
<head>
    ...
    <title>Update a estimate from the AutoBody Repair Shop database</title>
...
<body>
    <h3>Update a estimate from the AutoBody Repair Shop database</h3>
    <?php
            ...
            <div class='row'>
                <div class='col-25'>
                    <label for='estimate'>Select a Estimate to update:</label>
                </div>
            <div class='col-75'>
...
echo "
<form id='update' name='update' method='POST' action='UpdateEstimate.php'>";
            ...
            echo "
                ...
                <br>
                <br>
                <input type='submit' value='Update Estimate'>
            </form>
            <br>";
            ?>
    <?php
            ...
            date = '".$_POST['date']."'
            WHERE estimateID = ".$_POST['estimateID'].";"
            ;            
